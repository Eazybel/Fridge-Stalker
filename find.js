...
const identifier = async () => {
  ...
  const res1= await fetch(`https://api.spoonacular.com/recipes/${data.id}/information?includeNutrition=true&apiKey=4a12b45436ee468ab2e129244d4beaaf`)
...
lookup.onclick = async () => {
  ...
  const res1= await fetch(`https://api.spoonacular.com/recipes/${outer.id}/information?includeNutrition=true&apiKey=4a12b45436ee468ab2e129244d4beaaf`)
    const data1=await res1.json()
